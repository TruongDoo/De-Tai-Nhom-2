...
describe('NhanVien Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'nhan-vien', component: NhanVienComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.nhanViens?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
