...
describe('HoSo Management Component', () => {
  let comp: HoSoComponent;
  let fixture: ComponentFixture<HoSoComponent>;
  let service: HoSoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ho-so', component: HoSoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(HoSoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.hoSos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
